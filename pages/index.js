...
import { getPrefixEmail } from '../src/function/lib'
                        ...
                        <div className={`${style.user} dropdown`}>
                            ...
                            <ul className={`${style.dropdown} dropdown-menu`}>
                                <li className='d-flex px-3 align-items-center'>
                                    {
                                        (JSON.parse(localStorage.getItem("logged_user"))?.providerId) == null ? 
                                    ...
                                    {(userData?.user?.displayName) ? userData?.user?.displayName : getPrefixEmail(userData?.user?.email)}
                                </li>
                                <li>

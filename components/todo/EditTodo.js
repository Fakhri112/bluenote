                                                        ...
                                                        >
                                                            <div>
                                                                <button {...provided.dragHandleProps} >
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="40 20 140 140">
                                                                ...
                                                                <TextareaAutosize className={`${style.editTodo}`}
                                                                    defaultValue={data.todo}
                                                                    onChange={() => editTodoList(event, data.id)}
                                                                    ref={(el) => (todoRef.current[index] = el)}
                                                                    id={`${index}`}
                                                                    onBlur={() => (
                                                                        ((index == 0 && data.todo == "") || (index == props.todoData.length - 1 && data.todo == "")) && deleteTodoList(data.id)
                                                                    )}
                                                                />
